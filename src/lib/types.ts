export interface Plain<Name extends string, Data extends {}, Cause extends (Error | undefined)> {
  message: string;
  name: Name;
  data: Data;
  cause: Cause;
...
export interface Incident<Name extends string, Data extends {}, Cause extends (Error | undefined)>
  extends Error, Plain<Name, Data, Cause> {
  name: Name;
  stack: string;
...
export interface StaticIncident {
  ...
  new<N extends string, D extends {}                 >(          name: N, data: D, message?: string | ((data: D) => string) ): Incident<N,      D,  undefined>;
     ...
     <N extends string, D extends {}                 >(          name: N, data: D, message?: string | ((data: D) => string) ): Incident<N,      D,  undefined>;
}
// tslint:enable
